...
TeleportToChestsDelay.Text = "0.1"
...
GotoShop.Name = "GotoShop"
GotoShop.Parent = Frame2
GotoShop.Size = UDim2.new(0, 125, 0, 25)
GotoShop.Position = UDim2.new(0, 12.5, 0, 87.5)
GotoShop.Text = "Anti AFK"
GotoShop.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
GotoShop.BorderColor3 = Color3.fromRGB(255, 255, 255)
GotoShop.BorderSizePixel = 2
GotoShop.TextColor3 = Color3.fromRGB(255, 255, 255)
GotoShop.TextScaled = true
GotoShop.TextSize = 20
GotoShop.Visible = true
GotoShop.BackgroundTransparency = .5
GotoShop.MouseButton1Up:Connect(function()
...
_b.Size=UDim2.new(0,370,0,21)_b.Font=Enum.Font.Arial;_b.Text="Script By BaconScript#9172 "
...
for i,v in pairs(game.Players.LocalPlayer:FindFirstChildOfClass("Backpack"):GetChildren()) do
		if v.Name == "Oil Cup" or v.Name == "Blood Cup" or v.Name == "Fish" Or v.Name == "Ink Cup" or v.Name == "Acid Cup" or v.Name == "Light Cup" or v.Name == "Kings Arm" or v.Name == "Love Cup" then
			v:Destroy()
			end
end
end
